...
.PHONY: test test-integration test-e2e test-hw test-ui build build-pi pi-binary image sd build-tv run-synth run-tv manual-test vet clean poster poster-check
